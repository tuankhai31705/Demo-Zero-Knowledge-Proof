...
Demo thực nghiệm **Zero-Knowledge Proof** (ZKP): Chứng minh *"tôi biết x sao cho hash(x) = y"* mà **không tiết lộ giá trị x**.

## 📋 Tổng quan

| Thành phần | Mô tả |
|-----------|-------|
| **Circuit** | Poseidon hash circuit viết bằng Circom |
| **ZKP Protocol** | Groth16 (zk-SNARK) |
| **Trusted Setup** | Powers of Tau ceremony (bn128) |
| **Benchmark** | So sánh kích thước proof và thời gian sinh/xác minh |
| **Web Demo** | Giao diện web chạy ZKP trực tiếp trong browser |
...
**Ví dụ trong demo này:**
- Prover biết giá trị bí mật `x = 12345`
- Prover tạo proof chứng minh: "Tôi biết x sao cho Poseidon(x) = y"
- Verifier xác minh proof → ✅ Hợp lệ
- Verifier **KHÔNG biết** x là gì

```
Prover                          Verifier
  │                                │
  │  biết x = 12345                │
  │  tính y = Poseidon(12345)      │
  │  sinh ZK proof π               │
  │                                │
  │  ──── gửi (π, y) ────────►    │
  │  (KHÔNG gửi x)                │
